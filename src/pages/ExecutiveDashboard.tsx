              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Button className="h-20 flex flex-col" onClick={() => handleQuickAction("Approve All Pending Loans")}>
                      <TrendingUp className="h-6 w-6 mb-2" />
                      Approve Pending Loans
                    </Button>
                    <Button className="h-20 flex flex-col" onClick={() => handleQuickAction("Send Weekly Report")}>
                      <User className="h-6 w-6 mb-2" />
                      Send Weekly Report
                    </Button>
                    <Button className="h-20 flex flex-col" onClick={() => handleQuickAction("System Maintenance")}>
