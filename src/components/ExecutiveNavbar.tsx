      ...
      <GlassNav variant="executiveLight" className="py-2 px-6 border-b border-green-200/80 shadow-lg">
        <div className="container mx-auto flex justify-between items-center">
          ...
          >
              ...
              <TooltipTrigger asChild>
                ...
                >
                  <img
                    ...
                    alt="Profile"
                    className="w-9 h-9 rounded-full border-2 border-green-300 shadow-md hover:shadow-lg transition-all duration-300 object-cover"
                  />
                </button>
              </TooltipTrigger>
            ...
            {showProfileMenu && (
              <div className="absolute right-4 top-16 w-48 bg-green-50 rounded-xl shadow-xl z-50 border border-green-200 animate-fade-in">
                <div className="p-4 border-b border-green-200">
                  <div className="font-semibold text-green-900">Executive User</div>
                  <div className="text-xs text-green-600">executive@agrilift.com</div>
                </div>
                <div className="py-2">
                  <button onClick={() => { setShowProfileMenu(false); navigate('/profile'); }} className="block w-full text-left px-4 py-2 text-green-800 hover:bg-green-100/80 rounded-lg transition-all">Profile</button>
                  <button onClick={() => { setShowProfileMenu(false); navigate('/executive/settings'); }} className="block w-full text-left px-4 py-2 text-green-800 hover:bg-green-100/80 rounded-lg transition-all">Settings</button>
                  <button onClick={handleLogout} className="block w-full text-left px-4 py-2 text-green-800 hover:bg-green-100/80 rounded-lg transition-all">Logout</button>
                </div>
              </div>
            )}
          </motion.div>
