...
const Field3D: React.FC<Field3DProps> = ({ crops, rotationEnabled }) => {
  ...
  return (
    <div className="w-full h-96 rounded-lg overflow-hidden border shadow bg-gradient-to-b from-sky-200 to-green-100 relative">
      <Canvas 
        shadows 
      ...
      <div className="absolute top-3 right-3 space-y-2">
        <button 
          ...
          className="bg-white/90 hover:bg-white p-2 rounded-lg shadow-lg text-xs font-medium transition-colors"
        >
