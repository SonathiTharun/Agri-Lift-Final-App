...
const FieldGround = () => {
  ...
  return (
    <mesh ref={meshRef} receiveShadow rotation={[-Math.PI / 2, 0, 0]}>
      ...
      <meshStandardMaterial color={"#96df71" as any} roughness={0.7} />
    </mesh>
  );
};
      ...
      <Canvas shadows camera={{ position: [0, 7, 9], fov: 48 }}>
        ...
        <group ref={groupRef} position={[0, 0, 0]}>
          ...
          <mesh position={[0, 0, 0]}>
            ...
            <meshStandardMaterial color={"#e3ce97" as any} roughness={0.95} />
          </mesh>
          {/* Blue water channel */}
          <mesh position={[0, 0.05, 1.6]}>
            <boxGeometry args={[7, 0.09, 0.22]} />
            <meshStandardMaterial color={"#33C3F0" as any} transparent opacity={0.62} />
          </mesh>
          {/* Yellow fertilizer ring */}
          <mesh position={[-2, 0.06, -1.2]} rotation={[-Math.PI/2, 0, 0]}>
            <torusGeometry args={[0.6, 0.07, 12, 32]} />
            <meshStandardMaterial color={"#FFF07F" as any} transparent opacity={0.72} />
          </mesh>
          {/* Planted crops */}
